...
def generate_sample_dataset(output_dir="data/raw", force=False):
    ...
    for i, name in enumerate(restaurant_names, start=1):
        ...
        # Intentionally messy cost formatting to mimic real raw food delivery data ("₹ 400" or "--" or "350")
    ...
    print(f"✅ Successfully generated food delivery dataset in '{output_dir}':")
