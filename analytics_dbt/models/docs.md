...
Dimension table for partner restaurants containing normalized profiles, geographic locations, rating metrics, price ranges, and aggregated gross merchandise value (GMV).
{% enddocs %}

{% docs dim_users_doc %}
Dimension table containing registered customer accounts, demographics (age, gender, city), signup timestamps, and order history aggregates.
{% enddocs %}
