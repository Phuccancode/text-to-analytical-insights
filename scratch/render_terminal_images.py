...
lines_pipeline = [
    ...
    "=========================================================================",
    "🚀 STARTING END-TO-END DATA & AI PIPELINE (LOCAL STACK)",
    "=========================================================================",
    "",
    "1️⃣ STEP 1: Generating Raw Food Delivery Datasets...",
    "✅ Successfully generated food delivery dataset in 'data/raw':",
    ...
    "📦 LocalStack S3 Bucket 's3://analytics-data-lake' active.",
    "  └─ Uploaded 7 raw CSV tables ➔ s3://analytics-data-lake/raw/",
    "✅ All raw datasets successfully landed in AWS LocalStack S3!",
    "",
    "3️⃣ STEP 3: Loading Bronze RAW schema into DuckDB Warehouse...",
    "🔄 Loading raw tables into DuckDB Warehouse ('analytics_dw.duckdb')...",
    "  ├─ RAW.restaurants: 20 rows | RAW.users: 100 rows",
    "  ├─ RAW.orders: 600 rows | RAW.reviews: 250 rows",
    ...
    "✅ LLM Enrichment Complete! Created 'AI.REVIEW_ENRICHED' with 250 rows.",
    "=========================================================================",
...
lines_s3 = [
    ...
    "316ad37394c0   localstack/localstack:3.0.0   0.0.0.0:4566->4566/tcp   analytics_localstack",
    "",
    "$ python3 scripts/init_localstack_s3.py",
    "📦 LocalStack S3 Bucket 's3://analytics-data-lake' already exists.",
    "  └─ Uploaded menu.csv        ➔ s3://analytics-data-lake/raw/menu/menu.csv",
    "  └─ Uploaded order_items.csv ➔ s3://analytics-data-lake/raw/order_items/order_items.csv",
    "  └─ Uploaded orders.csv      ➔ s3://analytics-data-lake/raw/orders/orders.csv",
    "  └─ Uploaded restaurants.csv ➔ s3://analytics-data-lake/raw/restaurants/restaurants.csv",
    "  └─ Uploaded food.csv        ➔ s3://analytics-data-lake/raw/food/food.csv",
    "  └─ Uploaded reviews.csv     ➔ s3://analytics-data-lake/raw/reviews/reviews.csv",
    "  └─ Uploaded users.csv       ➔ s3://analytics-data-lake/raw/users/users.csv",
    "",
    "✅ All raw datasets successfully landed in AWS LocalStack S3!",
]
